...
PYBIND11_MODULE(wimf_v2_cpp, m) {
    ...
    m.def("runtime_info", [] { auto r=runtime_info(); return py::dict("architecture"_a=r.architecture,"simd"_a=r.simd,"hardware_threads"_a=r.hardware_threads,"codec_version"_a="2.2","native_orchestration"_a=true,"execution_policies"_a=py::make_tuple("synchronous","threaded"),"zstandard_version"_a=ZSTD_VERSION_STRING); });
