...
covers exact lossless Raw, Predictive, Palette, and Wavelet tiles; grayscale;
RGBA; 10/16-bit samples; odd multi-tile edges; four-tile ROI reconstruction;
thread determinism; and checksum rejection after payload corruption.
